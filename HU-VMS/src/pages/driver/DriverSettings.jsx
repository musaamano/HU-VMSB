...
const DriverSettings = () => {
  ...
  const [accountSettings, setAccountSettings] = useState({
    ...
    vehicleAssigned: 'Toyota Hilux - HU-2045',
  ...
  useEffect(() => {
    ...
    const savedProfilePhoto = localStorage.getItem('driverProfilePhoto');
  ...
  const saveAllSettings = () => {
    ...
    localStorage.setItem('driverSettings', JSON.stringify(allSettings));
  ...
  const handleSaveAccount = () => {
    ...
    const event = new CustomEvent('driverAccountSettingsUpdated', {
    ...
    window.dispatchEvent(new StorageEvent('storage', {
      key: 'driverSettings',
      newValue: localStorage.getItem('driverSettings')
    }));
  ...
  const handleExportSettings = () => {
    ...
    link.href = url;
    link.download = `driver-settings-${new Date().toISOString().split('T')[0]}.json`;
    link.click();
    ...
    <div className="driver-settings-container">
      ...
      <div className="driver-settings-content">
        <div className="driver-settings-tabs">
          <button className={`driver-settings-tab ${activeTab === 'account' ? 'active' : ''}`} onClick={() => setActiveTab('account')}>
            <span className="tab-icon">👤</span> Account
          </button>
          <button className={`driver-settings-tab ${activeTab === 'password' ? 'active' : ''}`} onClick={() => setActiveTab('password')}>
            <span className="tab-icon">🔒</span> Password
          </button>
          <button className={`driver-settings-tab ${activeTab === 'security' ? 'active' : ''}`} onClick={() => setActiveTab('security')}>
            <span className="tab-icon">🛡️</span> Security
          </button>
          <button className={`driver-settings-tab ${activeTab === 'notifications' ? 'active' : ''}`} onClick={() => setActiveTab('notifications')}>
            <span className="tab-icon">🔔</span> Notifications
          </button>
          <button className={`driver-settings-tab ${activeTab === 'system' ? 'active' : ''}`} onClick={() => setActiveTab('system')}>
            <span className="tab-icon">💻</span> System
          </button>
          <button className={`driver-settings-tab ${activeTab === 'privacy' ? 'active' : ''}`} onClick={() => setActiveTab('privacy')}>
              ...
              <form className="driver-settings-form">
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" name="vehicleAssigned" value={accountSettings.vehicleAssigned} onChange={handleAccountChange} />
                  </div>
                  <div className="form-group">
              ...
              <form className="driver-settings-form">
                ...
                <div className="notification-types">
                  ...
                  <div className="security-options">
                    <div className="security-option">
                      <div className="option-info">
                        <h4>Trip Assignment Alerts</h4>
                        <p>New trip assignments and updates</p>
                      </div>
                      <label className="toggle-switch">
                        <input type="checkbox" name="tripAssignmentAlerts" checked={notificationSettings.tripAssignmentAlerts} onChange={handleNotificationChange} />
                        <span className="toggle-slider"></span>
                      </label>
                    </div>
                    <div className="security-option">
                      <div className="option-info">
                        <h4>Route Change Alerts</h4>
                        <p>Alerts for route changes and updates</p>
                      </div>
                      <label className="toggle-switch">
                        <input type="checkbox" name="routeChangeAlerts" checked={notificationSettings.routeChangeAlerts} onChange={handleNotificationChange} />
                        <span className="toggle-slider"></span>
                      </label>
                    </div>
                    <div className="security-option">
